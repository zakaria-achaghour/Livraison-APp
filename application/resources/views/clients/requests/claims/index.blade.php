            ...
            <div class="card-body pt-0">
                ...
                @php
                    ...
                    $columns = [
                        ...
                        ['data' => 'claims_object', 'name' => 'claims_object', 'title' => __('Obejct')],
                        ['data' => 'parcel_code', 'name' => 'parcel_code', 'title' => __('Parcel Code')],
                        ['data' => 'claims_statut', 'name' => 'claims_statut', 'title' => __('Status')],
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body px-5 my-7">
                    <!--begin::Form-->
                    <form id="claim_form" class="form"
                        action="{{ route('clients.requests.claims.store') }}">
                                    ...
                                    <div class="flex-row-fluid mb-8">
                                        ...
                                        <select class="form-select form-control form-control-solid form-select-sm"
                                            ...
                                            @foreach ($types as $type)
                                                <option value="{{ $type->name }}">{{ __($type->value) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="flex-row-fluid mb-8">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" name="code" class="form-control form-control-solid form-control-sm" placeholder="{{ __('Parcel Code') }}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
